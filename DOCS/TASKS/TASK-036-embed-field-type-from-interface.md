...
**Статус:** Детализировано (фаза 1 выполнена; фазы 2–4 в плане)  
**Приоритет:** Средний  
...
| **Фаза 4** | Поддержка смарт-процессов для полей-встроек | План |
...
- [ ] Каталог типов: «С кнопками», «Зависимые поля», «Свой handler»
- [ ] Выбор типа при создании поля-встройки
- [ ] Предопределённые типы создают поле с фиксированным handler

### Фаза 3 (план)

- [ ] Кнопка «Настроить» у полей-встроек в таблице
- [ ] Форма настроек для типа «С кнопками» (массив кнопок)
- [ ] Форма настроек для типа «Зависимые поля» (источник, список полей)
- [ ] Сохранение настроек, доступ handler'у

### Фаза 4 (план)

- [ ] Поля-встройки поддерживаются в смарт-процессах
