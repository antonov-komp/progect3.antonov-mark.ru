 ...
 * Откройте через браузер: http://progect3.antonov-mark.ru/outgoing-webhook/tools/check-web-server-sqlite.php
 */
...
echo "\n3. Проверка подключения к БД:\n";
// Правильный путь: из public/outgoing-webhook/tools/ в outgoing-webhook/database/
...
if (!file_exists($dbPath)) {
    echo "   ⚠ Файл БД не найден по пути: {$dbPath}\n";
    echo "   Создайте БД: php {$basePath}/outgoing-webhook/tools/init-database.php\n";
    exit(1);
}
